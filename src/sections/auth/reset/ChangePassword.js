...
const ChangePassword = () => {
  ...
  const { errors, dirty, isValid, touched, setErrors, setSubmitting, isSubmitting, getFieldProps } = formik;
  ...
  const handleSubmitAxios = async (e) => {
    ...
    if (token) {
      ...
      if ({ ...getFieldProps('newPassword') }.value === { ...getFieldProps('confirmPassword') }.value) {
        // reset call
        await axios
